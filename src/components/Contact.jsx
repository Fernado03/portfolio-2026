            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                >
                    ...
                    <a
                        ...
                        className="group p-6 bg-slate-900/50 rounded-xl border border-slate-800 hover:border-cyan-500/50 transition-all hover:-translate-y-1 flex items-center gap-4"
                    >
                        ...
                        <div>
                            ...
                            <p className="text-white font-medium group-hover:text-cyan-400 transition-colors">{HERO_CONTENT.email}</p>
                        </div>
                    </a>
                    ...
                    <a
                        ...
                        className="group p-6 bg-slate-900/50 rounded-xl border border-slate-800 hover:border-blue-500/50 transition-all hover:-translate-y-1 flex items-center gap-4"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group p-6 bg-slate-900/50 rounded-xl border border-slate-800 hover:border-purple-500/50 transition-all hover:-translate-y-1 flex items-center gap-4"
                    >
                        ...
                        <div>
                            <p className="text-gray-400 text-sm">View my code on</p>
                    ...
                    <a
                        ...
                        className="group p-6 bg-slate-900/50 rounded-xl border border-slate-800 hover:border-green-500/50 transition-all hover:-translate-y-1 flex items-center gap-4"
                    >
                        ...
                        <div>
                            ...
                            <p className="text-white font-medium group-hover:text-green-400 transition-colors">{HERO_CONTENT.phone}</p>
                        </div>
                    </a>
                </motion.div>
