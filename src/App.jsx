...
function App() {
  ...
  return (
    <ThemeProvider>
      ...
      <div className={`noise-overlay bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-900 dark:text-white selection:bg-cyan-500/30 relative overflow-x-hidden cursor-none ${!isLoaded ? 'opacity-0' : 'opacity-100'} transition-opacity duration-500`}>
        <CustomCursor />
        <CommandPalette />
        <ChatBot />
        <EasterEgg />
